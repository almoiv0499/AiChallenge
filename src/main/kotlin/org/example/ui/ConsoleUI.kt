...
object ConsoleUI {
    ...
    fun printWelcomeOffline() = println(
        """
        ╔══════════════════════════════════════════════════════════════╗
        ...
        ║    /profile setup   - настроить профиль (диалог)              ║
        ╠══════════════════════════════════════════════════════════════╣
        ║  💡 Примеры запросов:                                        ║
        ║    "Привет! Расскажи о себе"                                 ║
        ║    "Что такое Kotlin?"                                       ║
        ║    "Напиши функцию для сортировки массива"                   ║
        ║    "Объясни концепцию корутин"                               ║
        ╚══════════════════════════════════════════════════════════════╝
        """.trimIndent()
    )
    ...
    fun printHelp() = println(
        ...
        📌 Project Task API (порт 8084):
        • create_project_task  - создать задачу проекта
        • get_project_tasks    - получить список задач с фильтрами
        • update_project_task  - обновить задачу
        • get_project_status   - получить статус проекта
        • get_team_capacity    - получить загрузку команды
        ...
        • "Создай задачу: Интеграция платежей, приоритет HIGH"
        • "Покажи все задачи с приоритетом CRITICAL"
    ...
    fun printStartingServices() {
        ...
        println("   🌤️ Weather MCP Server: http://localhost:8082")
        println("   📦 Git MCP Server: http://localhost:8083")
